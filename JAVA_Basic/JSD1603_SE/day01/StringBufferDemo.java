 ...
 *   在 Java1.4 之前，StringBuffer 是字符串操作的唯一选择。但是它的一个缺点是所有公共方法都是同步的，
 *   StringBuffer 提供线程安全性，但以性能为代价；
 *   Java1.5 引入了一个新类 StringBuilder，除了(不支持)线程安全和同步之外，它与 StringBuffer 类似；
 *
